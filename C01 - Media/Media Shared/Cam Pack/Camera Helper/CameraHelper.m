...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    // Pick and choose whichever types you want to handle
    ...
    for (AVMetadataObject *metadata in metadataObjects)
    {
        if ([barCodeTypes containsObject:metadata.type])
        {
            ...
            if (_metadataDelegate && [_metadataDelegate respondsToSelector:@selector(processBarcode:withType:withMetadata:)])
                [_metadataDelegate processBarcode:stringValue withType:metadata.type withMetadata:object];
        }
        else if ([metadata.type isEqualToString:AVMetadataObjectTypeFace])
        {
            ...
            if (_metadataDelegate && [_metadataDelegate respondsToSelector:@selector(processFace:)])
