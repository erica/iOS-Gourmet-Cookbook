/*
 ...
 KNOWN BUG: From iOS 7.x to iOS 8.x, Apple made some changes to auto layout participation basically breaking this class. That's why the view now has its translatesAutoresizingMaskIntoConstraints property enabled and disabled in the moving routine. As a side-effect, expect to see a few minor errors in the console if you use size constraints on your draggable views. You can safely ignore these.
 */
